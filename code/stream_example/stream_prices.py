...
class PriceStreamer(StreamBase):
    ...
    def fire_new_price_event(self, instrument):
        #once it finsies process make it False
    ...
    def log_data(self):
        #take shared prices which is set of keys and values
        #keys instrument and value is liveapiprice which has a dict
